...
from app_users.auxiliary import get_avatar_url, get_errors, get_conversations
from app_messages.forms import *
...
def conversation (request, receiver_id):
    ...
    if request.method == 'POST':
        ...
        if bound_message_form.is_valid():
            ...
            return render (request, 'app_messages/conversation.html', ctx)
        else:
...
def new_conversation (request):
    ...
    if request.method == 'POST':
        ...
        if bound_message_form.is_valid():
            ...
            return render (request, 'app_messages/new_conversation.html', ctx)
